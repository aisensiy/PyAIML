...
what aisensiy do:
    I make the <system> tag to run python syntax not the shell, 
    just like the old alicebot which code in java use bashshell to implement <system> 
"""
import AimlParser
import DefaultSubs
import Utils
...
class Kernel:
    ...
    # <system>
    # now I make it run the python syntax
